...
A conversa aberta no início fica fixada como destinatária. Você pode navegar por outros chats durante a execução; antes de cada lote, o script busca e reabre automaticamente a conversa original.

Como o envio usa a interface do WhatsApp Web, a conversa original reaparece momentaneamente a cada lote. Para envio totalmente em segundo plano seria necessário usar a API oficial do WhatsApp.
...
- `Conversa não encontrada`: confirme que o contato continua com o mesmo nome exibido no WhatsApp.
